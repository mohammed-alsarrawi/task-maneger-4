...
import { ArrowLeftCircle, ArrowRightCircle, Edit, Eye, User } from "lucide-react";  // ✅ FIXED: Correct import


export default function TaskCard({ task, setEditTask, onMoveTask }) {
  const statusColors = {
